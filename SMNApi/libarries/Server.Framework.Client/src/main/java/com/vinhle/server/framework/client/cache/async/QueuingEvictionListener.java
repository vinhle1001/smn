...
* Date   : Jun 5, 2014
*/
package com.vinhle.server.framework.client.cache.async;
 ...
 * When eviction occurs, this class passes key, value pair to writeCache task,
...
public abstract class QueuingEvictionListener<K, V> implements AsyncEvictionListener<K, V> {
	 ...
	 * 
	 * @see
	 * com.cetsoft.imcache.writeCache.EvictionListener#onEviction(java.lang.Object,
	 * java.lang.Object)
	 */
	...
	/**
	 * Creates the writeCache task.
	 *
	 * @param key the key
	 * @param value the value
	 * @return the writeCache task
	 */
	 ...
	 * Save all.
	 *
	 * @param cacheTasks the writeCache tasks
	 */
	...
	protected static class SimpleCacheTask<K, V> implements CacheTask<K, V> {
		...
		/**
		 * Instantiates a new simple writeCache task.
		 *
		 * @param key the key
		 * @param value the value
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.cetsoft.imcache.writeCache.async.CacheTask#getKey()
		 */
		public K getKey() {
			return key;
		}
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.cetsoft.imcache.writeCache.async.CacheTask#getValue()
		 */
		public V getValue() {
			return value;
		}
