 ...
 * data retrieval operations on a writeCache at the cost of additional writes and
 * the use of more storage space to maintain the extra copy of data. Indexes are
 * used to quickly locate data without having to search every object in a writeCache.
 */
