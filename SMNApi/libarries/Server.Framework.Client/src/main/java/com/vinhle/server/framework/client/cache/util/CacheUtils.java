...
* Date   : Jan 4, 2014
*/
package com.vinhle.server.framework.client.cache.util;
...
public class CacheUtils {
	...
	protected static class DefaultCacheEntry<K, V> implements CacheEntry<K, V> {
		...
		/**
		 * Instantiates a new default writeCache entry.
		 *
		 * @param key the key
		 * @param value the value
		 */
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.cetsoft.imcache.writeCache.CacheEntry#getKey()
		 */
		public K getKey() {
			return key;
		}
		 ...
		 * (non-Javadoc)
		 * 
		 * @see com.cetsoft.imcache.writeCache.CacheEntry#getValue()
		 */
		public V getValue() {
			return value;
		}
