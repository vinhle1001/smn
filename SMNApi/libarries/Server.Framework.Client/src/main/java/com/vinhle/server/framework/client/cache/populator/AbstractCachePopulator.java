...
import com.vinhle.server.framework.client.cache.CachePopulator;

/**
 * The Class AbstractCachePopulator populates the writeCache.
 *
...
public abstract class AbstractCachePopulator<K, V> implements CachePopulator<K, V> {
	...
	/**
	 * Instantiates a new abstract writeCache populator.
	 *
