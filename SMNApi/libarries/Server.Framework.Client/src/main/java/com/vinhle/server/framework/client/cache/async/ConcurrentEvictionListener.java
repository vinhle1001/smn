...
import com.vinhle.server.framework.client.cache.util.ThreadUtils;
 ...
 * This class drains writeCache task queue and executes saveAll function for
 * writeCache tasks with multiple threads.
 *
...
public abstract class ConcurrentEvictionListener<K, V> extends QueuingEvictionListener<K, V> {
	...
	protected void init(int queueSize, int concurrencyLevel) {
		...
		// Creates runnables to drain writeCache task queue constantly.
