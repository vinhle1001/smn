...
public class BillReturnedDetailRequest implements Serializable {
    ...
    public BillReturnedDetailRequest(Integer billReturnedDetailId, Integer billDetailId, Integer productId, Integer productReturnedQuantity, String description, Long refundedCost) {
        ...
        this.isActive = AppSetting.ACTIVE;
    }
