 ...
 */
public class ProductOfAgencyModel implements Serializable {
    ...
    public ProductOfAgencyModel() {
    }

    public ProductOfAgencyModel(Integer agencyProductId, Integer agencyId, Integer productId, Integer productQuantity, Integer productBeginningQuantity, byte isActive) {
