...
public class SearchableListDialog extends DialogFragment implements
    ...
    private void setData(View rootView) {
        ...
        listAdapter = new SearchableSpinnerAdapter(getActivity(), items);
        ...
        _listViewItems.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                _searchableItem.onSearchableItemClicked((BaseSearchableModel) listAdapter.getItem(position), position);
                getDialog().dismiss();
            }
        });
    }
...
//                _listViewItems.clearTextFilter();
    ...
    public interface SearchableItem extends Serializable {
        void onSearchableItemClicked(BaseSearchableModel item, int position);
    }
